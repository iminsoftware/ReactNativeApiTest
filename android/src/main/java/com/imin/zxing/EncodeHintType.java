...
public enum EncodeHintType {
   ...
   * {@link com.imin.zxing.qrcode.decoder.ErrorCorrectionLevel ErrorCorrectionLevel}.
  ...
  /**
   * Specifies the matrix shape for Data Matrix (type {@link com.imin.zxing.datamatrix.encoder.SymbolShapeHint})
   */
  DATA_MATRIX_SHAPE,
   ...
   * {@link com.imin.zxing.datamatrix.DataMatrixWriter#encode(String, BarcodeFormat, int, int)}
   */
  @Deprecated
  MIN_SIZE,
   ...
   * {@link com.imin.zxing.pdf417.encoder.Compaction Compaction} or {@link String} value of one of its
   * enum values).
   */
  PDF417_COMPACTION,
   ...
   * {@link com.imin.zxing.pdf417.encoder.Dimensions Dimensions}).
   */
  PDF417_DIMENSIONS,
